...
package body I18N.Runtime.Tests.Compilation is
   ...
   begin
      I18N.Runtime.Compatibility.Initialize_Message
        (Runtime, "{gender, select, male {He} female {She} other {They}}");
      Add_Arg (Args, "gender", "female");
      declare
         Result : constant I18N.Errors.Result :=
           I18N.Runtime.Compatibility.Render (Runtime, Args);
      begin
         AUnit.Assertions.Assert
           (Condition =>
              Result.Ok and then I18N.Errors.Value_Text (Result) = "She",
            Message   => "compiled select should jump to the female branch");
      end;
      I18N.Runtime.Finalize (Runtime);
