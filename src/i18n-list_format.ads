...
--  c"), consulting the runtime "formats" data file for locales the crate's
--  `locales` configuration narrowed out of the compiled tables and falling
--  back to those tables otherwise. Message renderers delegate here instead of
